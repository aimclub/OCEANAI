...
_b5.download_file_from_url(
    url = 'https://download.sberdisk.ru/download/file/477995980?token=jGPtBPS69uzFU6Y&filename=' + FILENAME_1,
    out = False
)
_b5.download_file_from_url(
    url = 'https://download.sberdisk.ru/download/file/477995963?token=bTpo96qNDPcwGqb&filename=' + FILENAME_2,
    out = False
)
