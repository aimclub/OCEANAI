...
def test_get_audio_union_predictions():
    ...
    url_openness = _b5.weights_for_big5_["audio"][corpus]["b5"]["openness"][DISK]
    url_conscientiousness = _b5.weights_for_big5_["audio"][corpus]["b5"]["conscientiousness"][DISK]
    url_extraversion = _b5.weights_for_big5_["audio"][corpus]["b5"]["extraversion"][DISK]
    url_agreeableness = _b5.weights_for_big5_["audio"][corpus]["b5"]["agreeableness"][DISK]
    url_non_neuroticism = _b5.weights_for_big5_["audio"][corpus]["b5"]["non_neuroticism"][DISK]
...
def test_get_video_union_predictions():
    ...
    url_openness = _b5.weights_for_big5_["video"][corpus]["b5"]["openness"][DISK]
    url_conscientiousness = _b5.weights_for_big5_["video"][corpus]["b5"]["conscientiousness"][DISK]
    url_extraversion = _b5.weights_for_big5_["video"][corpus]["b5"]["extraversion"][DISK]
    url_agreeableness = _b5.weights_for_big5_["video"][corpus]["b5"]["agreeableness"][DISK]
    url_non_neuroticism = _b5.weights_for_big5_["video"][corpus]["b5"]["non_neuroticism"][DISK]
...
def test_get_av_union_predictions():
    ...
    url_openness = _b5.weights_for_big5_["av"][corpus]["b5"]["openness"][DISK]
    url_conscientiousness = _b5.weights_for_big5_["av"][corpus]["b5"]["conscientiousness"][DISK]
    url_extraversion = _b5.weights_for_big5_["av"][corpus]["b5"]["extraversion"][DISK]
    url_agreeableness = _b5.weights_for_big5_["av"][corpus]["b5"]["agreeableness"][DISK]
    url_non_neuroticism = _b5.weights_for_big5_["av"][corpus]["b5"]["non_neuroticism"][DISK]
