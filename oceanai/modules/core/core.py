        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    norm_traits_with_target_copy[:, 0] = np.where(norm_traits_with_target[:, 0] > 0, name_mbti[0][0], name_mbti[0][1])
                    norm_traits_with_target_copy[:, 1] = np.where(norm_traits_with_target[:, 1] > 0, name_mbti[1][1], name_mbti[1][0])
                    norm_traits_with_target_copy[:, 2] = np.where(norm_traits_with_target[:, 2] > 0, name_mbti[2][1], name_mbti[2][0])
                    norm_traits_with_target_copy[:, 3] = np.where(norm_traits_with_target[:, 3] > 0, name_mbti[3][0], name_mbti[3][1])
