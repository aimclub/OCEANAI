...
`OCEANAI <https://github.com/DmitryRyumin/oceanai>`_ включает три основных алгоритма:
...
`OCEANAI <https://github.com/DmitryRyumin/oceanai>`_ признаки позволят исследователям решать другие задачи анализа поведения
человека, например распознавание его аффективных состояний.

`OCEANAI <https://github.com/DmitryRyumin/oceanai>`_ использует самые актуальные библиотеки с открытым исходным кодом
...
`OCEANAI <https://github.com/DmitryRyumin/oceanai>`_ написана на языке программирования
