...
MOCK_MODULES = [
    'tensorflow', 'keras', 'Keras-Applications', 'numpy', 'scipy', 'pandas', 'requests', 'requests.exceptions',
    'requests.adapters', 'requests.structures', 'opensmile', 'librosa', 'librosa.display', 'audioread', 'soundfile',
    'scikit-learn', 'opencv-contrib-python', 'pymediainfo', 'mediapipe', 'pytest'
]
